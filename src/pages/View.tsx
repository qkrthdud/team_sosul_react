...
const View: React.FC = () => {
    ...
    const state = location.state as { fatchdata: Campground | undefined };
    ...
    useEffect(() => {
        ...
        if (state?.fatchdata) {
          ...
          // 새로고침 등의 이유로 state가 없는 경우를 대비해 fallback 처리
          // 예: navigate("/product") 또는 fetch(`/api/campgrounds/${id}`)
          console.warn("데이터가 존재하지 않아 fallback 처리를 시도합니다.");
        }
      }, [state, navigate]);
    
      if (!campground) {
        return <div>아직 안왔습니다.</div>;
      }
                            ...
                            <div className="h_vinfo_wrap">
                                ...
                                <div className="h_vinfo_imgbox">
                                    <div className="h_vinfo_campingimg">
                                        <img src={campground && campground.main_photo_url as string} alt="캠핑장시설사진" />
                                    </div>
                            ...
                            <div className="sticky_box">
                                ...
                                <div className="rescheck_sy">
                                    ...
                                    <button
                                        ...
                                        onClick={() => navigate(`/reservation/${campground.id}`)}
                                    >
                                        예약하기
                                    </button>
                                </div>
