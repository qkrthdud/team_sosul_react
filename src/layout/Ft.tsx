        ...
        <div className="container">
            ...
            <ul className="sns d-flex align-items-center">
                    ...
                    <ul className="sns_icon_box d-flex align-items-center ">
                        <li className="ytube">
                            <a className="icon_area icon_area flex items-center justify-center w-9 h-9" href="https://www.youtube.com/">
                        ...
                        <li className="blog">
                            <a className="icon_area icon_area flex items-center justify-center w-9 h-9" href="https://blog.naver.com/chzfk">
                        ...
                        <li className="insta">
                            <a className="icon_area icon_area flex items-center justify-center w-9 h-9" href="https://www.instagram.com/sosul_camplife/">
                        ...
                        <li className="google">
                            <a className="icon_area" href="https://play.google.com/store/games?hl=ko">
                                <svg xmlns="//www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
                        ...
                        <li className="apple">
                            <a className="icon_area" href="https://www.apple.com/kr/app-store/">
                                <svg xmlns="//www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
        ...
        <div className="container pt-8">
            <div className="btm_info_box">
                ...
                <div className="btm_txt">
                    ...
                    <div className="btm_txt_in">(주)소슬은 통신판매 중개자로서 통신판매의 당사자가 아니며 상품의 예약, 이용 및 환불 등과 관련한 의무와 책임은 각 판매자에게 있습니다. Copyright 2025. SOSUL</div>
                </div>
            </div>
        </div>
    </footer>
